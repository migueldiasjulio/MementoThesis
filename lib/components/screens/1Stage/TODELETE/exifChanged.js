...
var MEMEXIF = function(){
  ...
  this.ExifTags = {
    ...
    this.imageHasData = function(img) {
        return !!(img.exifdata);
    }
    
    this.base64ToArrayBuffer = function(base64, contentType) {
    ...
    this.objectURLToBlob = function(url) {
    ...
    this.findEXIFinJPEG = function(file) {
    ...
    this.readTags = function(file, tiffStart, dirStart, strings, bigEnd) {
    ...
    this.readTagValue = function(file, entryOffset, tiffStart, dirStart, bigEnd) {
    ...
    this.getData = function(img) {
        if ((img instanceof Image || img instanceof HTMLImageElement)) return false;
    ...
    this.startHere = function(thesrc){
    ...
    this.getTag = function(img, tag) {
        if (!this.imageHasData(img)) return "Nao tem data";
