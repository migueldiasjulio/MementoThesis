...
class ExifExtractor extends Object with Observable {
   ...
   * Singleton
   */
  static ExifExtractor _instance; 
  ...
  static ExifExtractor get() {
    if (_instance == null) {
      _instance = new ExifExtractor._();
    }
    return _instance;
  }
  ...
  function findEXIFinJPEG(file) {
      ...
      if (debug) print("Got file of length " + file.byteLength);
      if ((dataView.getUint8(0) != 0xFF) || (dataView.getUint8(1) != 0xD8)) {
          if (debug) print("Not a valid JPEG");
      ...
      while (offset < length) {
          if (dataView.getUint8(offset) != 0xFF) {
              if (debug) print("Not a valid marker at offset " + offset + ", found: " + dataView.getUint8(offset));
          ...
          if (marker == 225) {
              if (debug) print("Found 0xFFE1 marker");
  ...
  function readEXIFData(file, start) {
      if (getStringFromDB(file, start, 4) != "Exif") {
          if (debug) print("Not valid EXIF data! " + getStringFromDB(file, start, 4));
          return false;
      }
      ...
      if (file.getUint16(tiffOffset) == 0x4949) {
          ...
          if (debug) print("Not valid TIFF data! (no 0x4949 or 0x4D4D)");
          return false;
      }

      if (file.getUint16(tiffOffset+2, !bigEnd) != 0x002A) {
          if (debug) print("Not valid TIFF data! (no 0x002A)");
          return false;
      }
      ...
      if (firstIFDOffset < 0x00000008) {
          if (debug) print("Not valid TIFF data! (First offset less than 8)" + file.getUint32(tiffOffset+4, !bigEnd));
          return false;
      }
