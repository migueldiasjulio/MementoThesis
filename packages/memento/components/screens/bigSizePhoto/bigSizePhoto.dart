...
class BigSizePhoto extends screenhelper.Screen with ChangeNotifier  {
  ...
  Element _name;
  @reflectable @published Thumbnail get thumbToDisplay => __$thumbToDisplay; Thumbnail __$thumbToDisplay = null; @reflectable set thumbToDisplay(Thumbnail value) { __$thumbToDisplay = notifyPropertyChange(#thumbToDisplay, __$thumbToDisplay, value); }
  ...
  @reflectable @observable bool get moving => __$moving; bool __$moving = false; @reflectable set moving(bool value) { __$moving = notifyPropertyChange(#moving, __$moving, value); }
